...
const ACCESS_TTL_RAW =
  process.env.ACCESS_TOKEN_TTL || process.env.JWT_ACCESS_EXPIRES || "15m";
const REFRESH_TTL_RAW =
  process.env.REFRESH_TOKEN_TTL || process.env.JWT_REFRESH_EXPIRES || "7d";
